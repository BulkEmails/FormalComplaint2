...
Yours faithfully,`;
            ...
            sendEmailButton.addEventListener("click", function () {
                const mailtoLink = `mailto:${allEmailAddresses}?subject=${encodeURIComponent('Formal Complaint – Online Threats Against Pakistan's CDF & COAS FM Asim Munir')}&body=${encodeURIComponent(defaultEmailBody)}`;
